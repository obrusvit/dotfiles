...
# yazi
export PATH=$HOME/repos/yazi/target/release:$PATH
# yazi - `y` will open yazi and will cwd after `q`, press `Q` to discard
function y() {
...
# opencode
export PATH=/home/obrusvit/.opencode/bin:$PATH
